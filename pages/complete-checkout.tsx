...
export default function CompleteCheckout() {
  return (
    <>
      <Head>
        <title>Checkout Complete - Yogameshop</title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="Yogameshop - Get a New Experience in Gaming"
        />
        <meta
        ...
        <div className="container-fluid">
          ...
          <div className="button-group d-flex flex-column mx-auto">
            ...
            <a
              ...
              href="https://wa.me/6281286601597?text=Saya%20telah%20melakukan%20pembayaran%20voucher%20game"
              role="button"
            >
              WhatsApp ke Admin
            </a>
